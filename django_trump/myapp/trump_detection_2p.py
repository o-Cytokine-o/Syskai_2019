...
def gen(camera,tut_frag):
    ...
    while(True):
        ...
        if field_state[0] == 3 and field_state[-1] == 3:
            ...
            #プレイヤー１の判定
            if 1 in field_list[1]: #プレイヤー１にAがあった場合
                if 1 in field_list[0]:   #ディーラーにAがあった場合
                    if (total_num_p1s <= 21) and (total_num_p1s > total_num_deas) or (21 < total_num_deas):
                        cv2.putText(frame, 'win', (int(width*0.25), int(height*0.75)), cv2.FONT_HERSHEY_SIMPLEX, font_size, back_color, back_th)
                        cv2.putText(frame, 'win', (int(width*0.25), int(height*0.75)), cv2.FONT_HERSHEY_SIMPLEX, font_size, font_color, front_th)
                    elif (total_num_p1s <= 21) and (total_num_p1s == total_num_deas):
                        cv2.putText(frame, 'drow', (int(width*0.25), int(height*0.75)), cv2.FONT_HERSHEY_SIMPLEX, font_size, back_color, back_th)
                        cv2.putText(frame, 'drow', (int(width*0.25), int(height*0.75)), cv2.FONT_HERSHEY_SIMPLEX, font_size, font_color, front_th)
                    elif (total_num_p1s > 21) and (total_num_deas > 21):
                        cv2.putText(frame, 'drow', (int(width*0.25), int(height*0.75)), cv2.FONT_HERSHEY_SIMPLEX, font_size, back_color, back_th)
                        cv2.putText(frame, 'drow', (int(width*0.25), int(height*0.75)), cv2.FONT_HERSHEY_SIMPLEX, font_size, font_color, front_th)
                    else:
                        cv2.putText(frame, 'lose', (int(width*0.25), int(height*0.75)), cv2.FONT_HERSHEY_SIMPLEX, font_size, back_color, back_th)
                        cv2.putText(frame, 'lose', (int(width*0.25), int(height*0.75)), cv2.FONT_HERSHEY_SIMPLEX, font_size, font_color, front_th)
                ...
                if 1 in field_list[0]: #ディーラーにAがなかった場合
            ...
            if 1 in field_list[2]:
                if 1 in field_list[0]:
                    if (total_num_p2s <= 21) and (total_num_p2s > total_num_deas) or (21 < total_num_deas):
                        cv2.putText(frame, 'win', (int(width*0.75), int(height*0.75)), cv2.FONT_HERSHEY_SIMPLEX, font_size, back_color, back_th)
                        cv2.putText(frame, 'win', (int(width*0.75), int(height*0.75)), cv2.FONT_HERSHEY_SIMPLEX, font_size, font_color, front_th)
                    elif (total_num_p2s <= 21) and (total_num_p2s == total_num_deas):
                        cv2.putText(frame, 'drow', (int(width*0.75), int(height*0.75)), cv2.FONT_HERSHEY_SIMPLEX, font_size, back_color, back_th)
                        cv2.putText(frame, 'drow', (int(width*0.75), int(height*0.75)), cv2.FONT_HERSHEY_SIMPLEX, font_size, font_color, front_th)
                    elif (total_num_p2s > 21) and (total_num_deas > 21):
                        cv2.putText(frame, 'drow', (int(width*0.75), int(height*0.75)), cv2.FONT_HERSHEY_SIMPLEX, font_size, back_color, back_th)
                        cv2.putText(frame, 'drow', (int(width*0.75), int(height*0.75)), cv2.FONT_HERSHEY_SIMPLEX, font_size, font_color, front_th)
                    else:
                        cv2.putText(frame, 'lose', (int(width*0.75), int(height*0.75)), cv2.FONT_HERSHEY_SIMPLEX, font_size, back_color, back_th)
                        cv2.putText(frame, 'lose', (int(width*0.75), int(height*0.75)), cv2.FONT_HERSHEY_SIMPLEX, font_size, font_color, front_th)
        ...
        #映像にそれぞれのプレイヤーの手札の合計値を表示する
            ...
            cv2.putText(frame, str(total_num_p1), (int(width*0.25), int(height*0.75)), cv2.FONT_HERSHEY_SIMPLEX, font_size, back_color, back_th)#輪郭用
            cv2.putText(frame, str(total_num_p1), (int(width*0.25), int(height*0.75)), cv2.FONT_HERSHEY_SIMPLEX, font_size, (0, 0, 255), 5)
            cv2.putText(frame, str(total_num_p2), (int(width*0.75), int(height*0.75)), cv2.FONT_HERSHEY_SIMPLEX, font_size, back_color, back_th)#輪郭用
            cv2.putText(frame, str(total_num_p2), (int(width*0.75), int(height*0.75)), cv2.FONT_HERSHEY_SIMPLEX, font_size, (0, 0, 255), 5)

            #手札にAがあった場合
            cv2.putText(frame, str(total_num_p1s), (int(width*0.25), int(height*0.85)), cv2.FONT_HERSHEY_SIMPLEX, font_size, back_color, back_th)#輪郭用
            cv2.putText(frame, str(total_num_p1s), (int(width*0.25), int(height*0.85)), cv2.FONT_HERSHEY_SIMPLEX, font_size, (255, 0, 255), 5)
            cv2.putText(frame, str(total_num_p2s), (int(width*0.75), int(height*0.85)), cv2.FONT_HERSHEY_SIMPLEX, font_size, back_color, back_th)#輪郭用
            cv2.putText(frame, str(total_num_p2s), (int(width*0.75), int(height*0.85)), cv2.FONT_HERSHEY_SIMPLEX, font_size, (255, 0, 255), 5)
